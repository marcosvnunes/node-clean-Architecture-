...
import { SaveSurveyResultRepository, SurveyResultModel, SaveSurveyResultParams } from './db-save-survey-retult-protocols'
import mockdate from 'mockdate'

const makeFakeurveyResult = (): SaveSurveyResultParams => ({
